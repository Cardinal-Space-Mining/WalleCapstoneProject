...
try:
    while True:  
        ...
        # Right Arm Vertical
        if (controller.get_d_pad_y() > 0 or controller.get_d_pad_y() < 0) and (kit.servo[rightArmVertical_channel].angle >= rightArmVertical_limits[0] + 10 and kit.servo[rightArmVertical_channel].angle <= rightArmVertical_limits[1] - 10):
