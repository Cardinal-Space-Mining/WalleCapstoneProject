...
try:
    while True:
        ...
        if (controller.get_r_trigger() == 1 and controller.get_d_pad_x() != 0) and (
            kit.servo[ch2].angle >= ch2limits[0] + 5
            and kit.servo[ch2].angle <= ch2limits[1] - 5
        ):
        ...
        if controller.get_r_joy_y() > 0.5 and (
            kit.servo[ch11].angle >= ch11limits[0] + 5
            and kit.servo[ch11].angle <= ch11limits[1] - 5
        ):
        ...
        if controller.get_r_joy_x() > 0.5 and (
            kit.servo[ch2].angle >= ch2limits[0] + 5
            and kit.servo[ch2].angle <= ch2limits[1] - 5
        ):
